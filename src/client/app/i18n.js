...
const ENGLISH = Object.freeze({
  ...
  "收件箱保存旅途中抵达的来信，寄件箱保存已经寄出的快照。": "The inbox keeps letters that arrive during the journey; Sent keeps immutable snapshots of letters you have sent.",
  "回信": "Reply",
  ...
  "信已经寄出，并作为快照放进寄件箱。": "The letter has been sent and saved as a snapshot in Sent.",
