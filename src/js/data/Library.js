...
本书的原型，源自加里敦学院（Garyton College）的一门核心课程——Rhet324: 叙事理论。

在最初的教学大纲中，我们致力于同学生们一道，在繁复的文学与哲学文本中清理出关于“叙事”的脉络。然而，随着研讨的深入，一个更为迫切的野心逐渐浮出水面：叙事理论更应是每一个现代人理解自身处境的生存工具。

正如我们在课程伊始所引用的那样：“一个在过去、现在和未来的筹划中定位自己，具有语言能力的成年人，是在叙事中展开他的行动和生活的。”这句略显晦涩的定义，实则道出了我们存在的真相——我们并非仅仅活在物理时间的流逝中，也是活在自己编织的故事里。

为了将这一学术洞见转化为更具普适性的生活指南，我们在原教材的基础上进行了大幅度的改写与扩充。本书试图跨越理论与生活的鸿沟，通过五个篇章的旅程，回答那个古老而常新的问题：“我”是谁？
...
在进入书写实践之前，我们需要首先绘制一张地图。当下的学术界正经历着一场深刻的“叙事转向”（Narrative Turn），学者们不再仅仅把故事看作文学作品，而是将其视为人类理解世界和自我的基本形式。这一转向可以梳理为两股主要的理论传统：

### 1. 诠释学传统：作为自我理解的叙事
第一股传统关注个体的内在时间与同一性，主要由现象学与伦理学哲学家所主导。

保罗·利科（Paul Ricoeur）在此提供了一个关键的区分：作为“同一性”（Idem）的自我与作为“自身性”（Ipse）的自我。前者是生物学意义上的持久，而后者是承诺与责任的主体。利科认为，连接这两者的桥梁正是叙事。
